...
Category.destroy_all
    ...
    kk = "https://cdn.pixabay.com/photo/2014/01/03/01/13/girl-237871_1280.jpg"
    count = 0 
...
5.times do |index|  
    ...
    if count == 1 
        ...
        kk = "https://cdn.pixabay.com/photo/2015/10/12/14/57/face-984031_1280.jpg"
    elsif count == 2
        ...
        kk = "https://cdn.pixabay.com/photo/2016/09/24/03/20/passion-1690965_1280.jpg"
    elsif count == 3
        ...
        kk = "https://cdn.pixabay.com/photo/2016/11/21/12/42/beard-1845166_1280.jpg"
    elsif count == 4
